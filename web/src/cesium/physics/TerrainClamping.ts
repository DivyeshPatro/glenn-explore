  ...
  public clampToGround(
    ...
    try {
      ...
      if (directClamp) {
        ...
        // console.log('groundCartographic', groundCartographic);
        // console.log('currentCartographic', currentCartographic);
        // console.log('groundOffset', this.groundOffset);
    ...
    return position; // Return original position if clamping fails
  }
